    ...
    <div className="mx-auto flex max-w-2xl flex-col items-center px-4 py-24 text-center">
      <GlassCard strong className="flex flex-col items-center gap-5 p-12">
        ...
        <div>
          ...
          <p className="mt-2 text-muted-foreground">No pudimos cargar el tiempo de esta ciudad. Puede ser un problema temporal de red o del servicio meteorológico.</p>
        </div>
