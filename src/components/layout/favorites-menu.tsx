...
import { CITIES, flagEmoji } from "@/lib/cities";
  ...
  return (
    <>
      ...
      >
        ...
        <aside
          className={cn(
            "glass-strong absolute right-0 top-0 flex h-full w-full max-w-sm flex-col p-6 transition-transform duration-400 ease-out",
          ...
          {favoriteCities.length === 0 ? (
            <div className="flex flex-1 flex-col items-center justify-center gap-3 text-center text-muted-foreground">
              ...
              <p className="max-w-[16rem] text-sm">
                Aún no tienes ciudades favoritas. Pulsa el corazón en cualquier
                ciudad para guardarla aquí.
              </p>
            </div>
          ) : (
