      ...
      <div className="mb-3 flex items-center justify-between">
        <div className="flex items-center gap-2 text-muted-foreground">
          <span
            ...
            style={{ color: accent ?? "hsl(199 89% 62%)", background: "hsl(0 0% 100% / 0.06)" }}
          >
            {icon}
          </span>
        ...
        <GripVertical
          size={16}
          className="cursor-grab text-muted-foreground/40 transition-colors group-hover:text-muted-foreground/70"
          aria-hidden
        />
      </div>
