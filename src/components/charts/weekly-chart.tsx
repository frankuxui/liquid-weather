  ...
  return (
    <ResponsiveContainer width="100%" height={240}>
      <LineChart data={data} margin={{ top: 10, right: 8, left: -18, bottom: 0 }}>
        ...
        <Line type="monotone" dataKey="Máxima" stroke="hsl(0 84% 66%)" strokeWidth={2.5} dot={{ r: 3, fill: "hsl(0 84% 66%)" }} activeDot={{ r: 5 }} />
        <Line type="monotone" dataKey="Mínima" stroke="hsl(199 89% 62%)" strokeWidth={2.5} dot={{ r: 3, fill: "hsl(199 89% 62%)" }} activeDot={{ r: 5 }} />
      </LineChart>
    </ResponsiveContainer>
  );
}
