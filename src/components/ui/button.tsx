...
const variants: Record<Variant, string> = {
  primary:
    "bg-primary text-primary-foreground shadow-glass-sm hover:brightness-110 active:scale-[0.98]",
  glass:
    "glass text-foreground hover:border-white/25 active:scale-[0.98]",
