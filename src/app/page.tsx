...
const FEATURES = [
  {
    ...
    description:
      "Temperatura, humedad, viento, presión, índice UV, calidad del aire y mucho más, actualizado al instante.",
  },
  {
    icon: LineChart,
    title: "Gráficas interactivas",
    description:
      "Visualiza la evolución de la temperatura, la lluvia y el viento con gráficas elegantes construidas con Recharts.",
  },
  {
    icon: Move,
    title: "Widgets reorganizables",
    description:
      "Arrastra y coloca cada widget donde prefieras. Tu disposición se guarda automáticamente en el navegador.",
  },
  {
    icon: Heart,
    title: "Ciudades favoritas",
    description:
      "Marca tus ciudades favoritas y accede a ellas al instante desde cualquier parte de la aplicación.",
  },
  {
    icon: LayoutGrid,
    title: "Filtros combinables",
    description:
      "Ordena y filtra por temperatura, humedad, viento, condición o favoritas. Los resultados se actualizan al momento.",
  },
  {
    icon: Sparkles,
    title: "Diseño Liquid Glass",
    description:
      "Una interfaz premium con transparencias, blur y profundidad inspirada en las últimas versiones de iOS.",
  },
];
      ...
      <section className="grid items-center gap-12 py-16 md:grid-cols-2 md:py-24">
        <div className="animate-fade-in">
          ...
          <h1 className="text-balance text-5xl font-semibold leading-[1.05] tracking-tight md:text-6xl">
            El tiempo con estilo{" "}
            <span className="text-gradient">Liquid Glass</span>
          </h1>
          <p className="mt-6 max-w-md text-lg leading-relaxed text-muted-foreground">
            Un dashboard meteorológico profesional con pronósticos en tiempo
            real, gráficas interactivas y widgets que reorganizas a tu gusto.
            Rápido, elegante y siempre actualizado.
          </p>
      ...
      <section id="features" className="scroll-mt-24 py-16">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="text-balance text-3xl font-semibold tracking-tight md:text-4xl">
            Todo lo que necesitas para seguir el clima
          </h2>
          <p className="mt-4 text-muted-foreground">
            Diseñado como un producto premium: cada detalle cuida el rendimiento,
      ...
      <section className="py-16">
        ...
        >
          ...
          <h2 className="mx-auto max-w-xl text-balance text-3xl font-semibold tracking-tight md:text-4xl">
            ¿Listo para ver el tiempo como nunca antes?
          </h2>
          <p className="mx-auto mt-4 max-w-md text-muted-foreground">
            Empieza ahora, sin registros ni claves de API. Solo tú y el clima,
